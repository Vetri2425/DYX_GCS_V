/**
 * Embedded Lua script for Rover QuickTune
 *
 * This script tunes the steering (turn rate) and speed controller gains
 * for rovers and boats. Designed for use in Circle mode.
 */

export const ROVER_QUICKTUNE_SCRIPT = `--[[
...
export default ROVER_QUICKTUNE_SCRIPT;
